...
| [Operational Panel — Superset](projects/superset-panel/) | Apache Superset · PostgreSQL · SQL | ✅ Done |
...
| [Excel Automatic Reports](projects/excel-reports/) | Excel · Power Query · VBA | 🚧 In progress |
...
- **Dashboards:** Power BI, Looker Studio, Apache Superset
- **Web apps:** Python 3.11, Streamlit, Plotly
- **Data engineering:** Pandas, Requests, openpyxl
- **Hosting:** GitHub Pages (portfolio) · Streamlit Cloud (demos)

---

## Running locally

Each project folder has its own `README.md` with setup instructions.

```bash
# Clone the repo
git clone https://github.com/AntonioFurtado90/portfolio.git
cd portfolio
```
...
- **Freelance platforms:** 99Freelas · Workana · Upwork
